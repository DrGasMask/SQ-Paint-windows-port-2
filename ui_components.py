...
class PaletteColorButton(QToolButton):
    """A colour swatch button: left-click picks the primary colour (normal
    'clicked' signal), right-click picks the secondary colour (right_clicked)."""
